...
<head>
	...
	<style>
		...
		.pagination a.active {
			background: #b71c1c;
			/* Tombol aktif lebih gelap */
			border-color: #8e0c0c;
			color: #fff;
			box-shadow: 0 5px 12px rgba(183, 28, 28, 0.6);
			/* Bayangan lembut */
			transform: scale(1.05);
			/* Sedikit diperbesar untuk menarik perhatian */
...
<body>
	...
	<section class="product spad" style="margin-top:3rem;">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
